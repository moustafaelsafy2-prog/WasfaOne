/* WasfaOne Frontend - Unified Logic */
...
const statusMsg = document.getElementById('statusMsg'); // رسالة حالة عامة
...
function setupEventListeners() {
    if (!generateBtn) {
        console.error("Generate button not found. DOM might not be fully loaded.");
        return;
    }
